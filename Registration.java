...
public class Registration extends JFrame {
    ...
    Registration() {
	    ...
	    img1 = new ImageIcon("D:/niloybhai/Movie/images/sadman.jpg");
		imgLabel2 = new JLabel(img1);
		imgLabel2.setBounds(600, 0,450,600);
		c.add(imgLabel2);
        ...
        label1.setBounds(80, 100, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf1 = new JTextField();
        tf1.setBounds(220, 110, 260, 30);
        tf1.setFont(f5);
        c.add(tf1);
        ...
        label1.setBounds(80, 135, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf2 = new JTextField();
        tf2.setBounds(220, 145, 260, 30);
        tf2.setFont(f5);
        c.add(tf2);
        ...
        label1.setBounds(80, 170, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf3 = new JPasswordField();
        tf3.setBounds(220, 180, 260, 30);
        tf3.setFont(f2);
        tf3.setEchoChar('*');
        c.add(tf3);
        ...
        securityQsn.setBounds(220, 215, 259, 30);
        ...
        label1.setBounds(80, 240, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf4 = new JTextField();
        tf4.setBounds(220, 250, 260, 30);
        tf4.setFont(f5);
        c.add(tf4);
        ...
        label1.setBounds(80, 275, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf5 = new JTextField();
        tf5.setBounds(270, 285, 215, 30);
        tf5.setFont(f5);
        c.add(tf5);
        ...
        label1 = new JLabel();
        label1.setText(" " + a + " + " + b + " ");
        label1.setBounds(180, 285, 75, 30);
        label1.setFont(f4);
